"""Classes and functions for reading QChem output files."""
...
_DefaultSystemLabel = "QChem Output File"
...
#===================================================================================================================================
# . QChem output file reader class.
#===================================================================================================================================
class QChemOutputFileReader ( TextFileReader ):
    ...
    def ToAbsorptionSpectrum ( self, context = None, frameIndex = -1, fwhm = _DefaultFWHM, useTransitionVelocityDipoleMoments = False ):
        """Return an absorption spectrum using the same defaults as QChem."""
...
# . Helper functions.
#===================================================================================================================================
def QChemOutputFile_ToAbsorptionSpectrum ( filename, context = None, frameIndex = -1, fwhm = _DefaultFWHM, useTransitionVelocityDipoleMoments = False ):
    """Helper function that reads an absorption spectrum from an QChem output file."""
    infile = QChemOutputFileReader ( filename )
    infile.Parse ( )
...
def QChemOutputFile_ToCoordinates3 ( filename, frameIndex = -1 ):
    """Helper function that reads the coordinates from an QChem output file."""
    infile = QChemOutputFileReader ( filename )
    infile.Parse ( )
    return infile.ToCoordinates3 ( frameIndex = frameIndex )

def QChemOutputFile_ToSystem ( filename, frameIndex = -1 ):
    """Helper function that reads a system from an QChem output file."""
    infile = QChemOutputFileReader ( filename )
    infile.Parse ( )
    return infile.ToSystem ( frameIndex = frameIndex )

# . Importer definitions.
#_Importer.AddHandler ( { Coordinates3 : QChemOutputFile_ToCoordinates3 ,
#                         System       : QChemOutputFile_ToSystem       } , [ "olog", "oout", "OLOG", "OOUT" ], "QChem Output", defaultFunction = QChemOutputFile_ToSystem )
